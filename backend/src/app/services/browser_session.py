...
() => {
  ...
  return {
    ...
    replyBusy: Boolean(document.querySelector('button[aria-label*="Stop response"], button[aria-label*="応答を停止"], button[aria-label*="生成を停止"], model-response[aria-busy="true"]')),
